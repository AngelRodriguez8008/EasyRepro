...
namespace Microsoft.Dynamics365.UIAutomation.Sample.UCI
{
    ...
    public class CreateAccountUCI
    {
        ...
        private readonly SecureString mfaSecrectKey = System.Configuration.ConfigurationManager.AppSettings["MfaSecrectKey"].ToSecureString();
        ...
        public void UCITestCreateAccount()
        {
            ...
            {
                xrmApp.OnlineLogin.Login(_xrmUri, _username, _password, mfaSecrectKey);
